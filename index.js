...
if (marcaEncontrada) {
    ...
    Toastify({
        text: `${option} tiene un precio de $${valorAuto}`,
        duration: 3000,
        gravity: "top",
        position: "right",
        backgroundColor: "green",
    ...
    Toastify({
        text: "Marca de automóvil no encontrada",
        duration: 3000,
        gravity: "top",
        position: "right",
        backgroundColor: "red",
...
if (valorAuto && cuota >= 1 && cuota <= 6) {
    ...
    Toastify({
        text: `El precio de la cuota es de $${precioCuota.toFixed(2)}`,
        duration: 3000,
        gravity: "top",
        position: "right",
        backgroundColor: "green",
    ...
    Toastify({
        text: "Número de cuotas no válido",
        duration: 3000,
        gravity: "top",
        position: "right",
        backgroundColor: "red",
